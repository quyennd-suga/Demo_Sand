...
Shader "Toony Colors Pro 2/Sugame/IceBlock"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		[NoScaleOffset] _MatCapRGB ("MatCap (RGB)", 2D) = "white" {}
		 _MatCapTexture ("MatCap Texture", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		TCP2_TEX2D_WITH_SAMPLER(_MatCapRGB);
		...
		CBUFFER_START(UnityPerMaterial)
			...
			float4 _Albedo_ST;
			fixed4 _Color;
			float4 _MatCapRGB_ST;
			float4 _MatCapRGB_TexelSize;
			float4 _MatCapTexture;
			fixed4 _MatCapColor;
		...
		Pass
		{
			...
			) : SV_Target
			{
				...
				float4 __normalMap = ( TCP2_TEX2D_SAMPLE(_NormalMap, _NormalMap, input.pack2.xy).rgba );
				float __bumpScale = ( _BumpScale );
				float4 __albedo = ( TCP2_TEX2D_SAMPLE(_Albedo, _Albedo, input.pack2.xy).rgba );
				...
				half3 matcap = ( TCP2_TEX2D_SAMPLE(_MatCapRGB, _MatCapRGB, capCoord * _MatCapRGB_TexelSize.xy * _MatCapRGB_ST.xy + _MatCapRGB_ST.zw).rgb * _MatCapTexture.xyz ) * __matcapColor;
				albedo *= matcap;
				#endif
		...
		HLSLINCLUDE
			...
			) : SV_TARGET
			{
				...
				// Shader Properties Sampling
				float4 __albedo = ( TCP2_TEX2D_SAMPLE(_Albedo, _Albedo, input.pack1.xy).rgba );
				float4 __mainColor = ( _Color.rgba );
				float __alpha = ( __albedo.a * __mainColor.a );
...
/* TCP_DATA u config(ver:"2.9.19";unity:"2022.3.62f3";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","SPECULAR_ANISOTROPIC","SPECULAR","SPECULAR_TOON","SPECULAR_SHADER_FEATURE","MATCAP","MATCAP_SHADER_FEATURE","MATCAP_MULT","BUMP","BUMP_SHADER_FEATURE","BUMP_SCALE","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[sp(name:"Albedo";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:True;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_Albedo";md:"[MainTexture]";gbv:False;custom:False;refs:"";pnlock:False;guid:"912b72af-0bd3-4e08-965e-396f50aa3b61";op:Multiply;lbl:"Albedo";gpu_inst:False;dots_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Main Color";imps:list[imp_mp_color(def:RGBA(1, 1, 1, 1);hdr:False;cc:4;chan:"RGBA";prop:"_Color";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"86297140-378d-462f-8a72-45c85a2c2cc5";op:Multiply;lbl:"Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,,,,,,,,,,,,sp(name:"MatCap Texture";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:False;sbt:True;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:True;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_MatCapRGB";md:"[NoScaleOffset]";gbv:False;custom:False;refs:"";pnlock:False;guid:"a67de91a-bdbc-4710-a981-cf39120defe3";op:Multiply;lbl:"MatCap (RGB)";gpu_inst:False;dots_inst:False;locked:False;impl_index:0),imp_mp_vector(def:(0, 0, 0, 0);fp:float;cc:3;chan:"XYZ";prop:"_MatCapTexture";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"0636de91-f4cb-4cdd-b2a7-3f0864ff83cc";op:Multiply;lbl:"MatCap Texture";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Normal Map";imps:list[imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"bump";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_NormalMap";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"22454b3c-5825-4013-b98e-e5f83c725670";op:Multiply;lbl:"Normal Map";gpu_inst:False;dots_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 2fd1b7aa5328242aed31a62939550306 */
